...
This repository records behavior recovered from a contributor-supplied title
image and from the ReXGlue runtime. The title image, extracted assets, generated
guest code, traces, and bulk analysis state are never committed.
...
compilation, not title behavior.
